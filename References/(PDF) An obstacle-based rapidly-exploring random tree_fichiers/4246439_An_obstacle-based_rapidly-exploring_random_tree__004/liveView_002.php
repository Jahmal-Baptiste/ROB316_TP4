...
var SekindoClientDetections_URL = function (config) {
	...
	this.setInfo();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.sekindo.com/live/liveView.php?s=101316&cbuster=1641265188&pubUrl=https://www.researchgate.net/publication/4246439_An_obstacle-based_rapidly-exploring_random_tree&x=SEKXLEN&y=SEKYLEN&vp_content=plembed1554oikjtpxv&subId=[SUBID_ENCODED]&cbuster=1578308183',
					origQString: 's=101316&cbuster=1641265188&pubUrl=https://www.researchgate.net/publication/4246439_An_obstacle-based_rapidly-exploring_random_tree&x=400&y=350&vp_content=plembed1554oikjtpxv&subId=[SUBID_ENCODED]',
					x: 400,
					y: 350,
					isSlider: false,
					isOutstream: false,
					...
					isAPI: false,
					debug: 0,
					ci: {"extra":{"schemaVer":"11","os":"Ubuntu","osVersion":"","osVersionMajor":"0","osVersionMinor":"0","deviceManufacturer":"","deviceModel":"","deviceCodeName":"","deviceType":"desktop","browser":"Firefox","browserType":"browser","browserVersion":"69.0","browserVersionMajor":"69","browserVersionMinor":"0"},"browser":"firefox","os":"linux","osVer":"","deviceType":"desktop"},
					geo: 'FR',
					dmaCode: 0,
					dynamicSetup: [["floatSetup",[[1280,1,400,225,"br",1,1,1,"below",[],0,4320],[0,0,0,0,"br",0,0,0,"below",[],0,0]]]],
					uuid: '5e131257d10ad',
